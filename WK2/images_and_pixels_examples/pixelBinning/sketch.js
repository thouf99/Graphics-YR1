    ...
    while (boxColumnIndex < boxesPerRow) {
      ...
      for (let boxRow = 0; boxRow < boxRows; boxRow++) {
        for (let boxColumn = 0; boxColumn < boxColumns; boxColumn++) {
          ...
          // return array of 4 values (R,G,B,A)
          totalRed += waveImage.pixels[pixelStartIndex];
          totalGreen += waveImage.pixels[pixelStartIndex + 1];
          totalBlue += waveImage.pixels[pixelStartIndex + 2];
          totalAlpha += waveImage.pixels[pixelStartIndex + 3];
        }
      }
      ...
      //let averageColor = color(averageRed,averageBlue,averageGreen,averageAlpha);
